          ...
          <form action="checkout.php" method="POST">
            <table class="cart_table">
              ...
              <tr class="cart_content">
                <td class="cart_image">
                  <img src="images/shop/products/1-1.jpg" alt="" />
                </td>
                <td class="cart_title">Traffic Cone</td>
                <td class="cart_price">
                  $<span class="product_per_price">15</span>
                </td>
                ...
                <td class="cart_total">
                  $<span class="product_total_price">15</span>
                </td>
              ...
              <tr class="cart_content">
                <td class="cart_image">
                  <img src="images/shop/products/2-1.jpg" alt="" />
                </td>
                <td class="cart_title">Safty Helmet</td>
                <td class="cart_price">
                  $<span class="product_per_price">17</span>
                </td>
                <td class="cart_quantity">
                  <div class="product_quantity_inner">
                    <span class="product_quantity_subtract">
                ...
                <td class="cart_total">
                  $<span class="product_total_price">17</span>
                </td>
                <td class="cart_removal">
                  <a href="#">
                    <i class="ion-android-close"></i>
              ...
              <tr class="cart_content">
                <td class="cart_image">
                  <img src="images/shop/products/3-1.jpg" alt="" />
                </td>
                <td class="cart_title">Traffic Cone</td>
                <td class="cart_price">
                  $<span class="product_per_price">15</span>
              ...
              <tr class="cart_content">
                <td class="cart_image">
                  <img src="images/shop/products/4-2.jpg" alt="" />
                </td>
                <td class="cart_title">Safty Helmet</td>
                <td class="cart_price">
                  $<span class="product_per_price">17</span>
              ...
              <div class="grand_total">
                ...
                <ul>
                  <li>
                    ...
                    <span class="value total_price">$1500</span>
                  </li>
                  <li>
