...
const Header02Nav = () => {
  useEffect(() => {
    ...
    function menuClickAction() {
      ...
      $(
        ".mr_menu_02 .mr_navmenu ul.main_menu li.menu-item-has-children"
      ).append(
        $(
          "<span class='submenu_opener d-xl-none'><i class='ion-arrow-right-b'></i></span>"
        )
      );
      $(".mr_menu_02 .main_menu li.menu-item-has-children .submenu_opener").on(
        "click",
        function (e) {
  ...
  return (
    <div
      className="dark-theme offcanvas offcanvas-start"
      tabIndex="-1"
      id="offcanvasHome"
